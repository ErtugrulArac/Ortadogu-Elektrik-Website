...
export default function MusteriTemsilcisi({
  ...
  const durumYazi =
    durum === "online" ? "Müsait" : durum === "meşgul" ? "Meşgul" : "Çevrimdışı";

  return (
    <section aria-label="Müşteri Temsilcisi" className="mx-auto w-[92%] max-w-5xl bg-transparent">
      <div className="relative isolate overflow-hidden rounded-2xl border border-white/10 bg-transparent shadow-[0_10px_40px_rgba(0,0,0,0.25)]">
        <div className="relative z-10 grid gap-6 p-6 md:grid-cols-[1fr,1.2fr] md:p-8">
          {/* SOL BLOK */}
          <div className="flex items-start gap-4">
            <div className="relative">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-600/60 to-indigo-700/60 ring-1 ring-white/10">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-cyan-400/30 bg-cyan-400/10 px-2.5 py-1.5 text-xs font-medium text-cyan-100 hover:bg-cyan-400/15 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 sm:px-3 sm:py-2 sm:text-sm"
                >
          ...
          <div className="rounded-xl border border-white/10 p-4 md:p-5 bg-transparent">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-emerald-400/30 bg-transparent px-4 py-2.5 text-sm font-semibold text-emerald-50 hover:bg-emerald-500/10 focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
