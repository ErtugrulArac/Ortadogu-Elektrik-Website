...
function InfiniteMovingLogos({
  ...
  direction = "left",
  speed = "normal",
  durationSeconds, // → opsiyonel: sabit süre
  pauseOnHover = true,
  className,
}: {
  items: Logo[];
  ...
  return (
    <section aria-label="Ortadoğu Elektrik istatistikler, müşteri yorumları ve referanslar" className="relative overflow-hidden bg-[#0b1320] text-white">
      ...
      <div className="relative mx-auto w-[92%] max-w-6xl px-6 md:px-12">
        ...
        {/* ===== Müşteri Yorumları (hızlandırıldı) ===== */}
        <section className="pt-16 md:pt-20 pb-12 md:pb-16">
          ...
          {/* Hız override sadece bu bölümde geçerli */}
          <div id="yorumlar-hizli" className="relative mt-10 md:mt-12">
            <InfiniteMovingCardsDemo />
            <style jsx global>{`
              /* Bileşenin içinde animate-scroll kullanılıyorsa */
              #yorumlar-hizli .animate-scroll {
                animation-duration: 28s !important; /* önceki 80s → 28s */
                animation-timing-function: linear !important;
              }
              /* Güvenli geniş hedef (animate-* türevleri) */
        ...
        <section className="pt-12 md:pt-16 pb-24 md:pb-28">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-semibold tracking-tight">
              <span className="bg-gradient-to-r from-blue-300 via-cyan-300 to-indigo-300 bg-clip-text text-transparent">
                Her müşteriyi uzun dönemli bir <br /> iş ortaklığı olarak görüyoruz
              </span>
            </h2>
          </motion.div>
