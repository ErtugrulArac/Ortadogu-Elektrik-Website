...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        // üst boşluk = 0, responsive min yükseklik, dıştan override edilebilir
        "group relative flex w-full items-center justify-center bg-white dark:bg-black pt-0 mt-0 " +
          "min-h-[28rem] md:min-h-[36rem] lg:min-h-[40rem]",
        containerClassName
      )}
